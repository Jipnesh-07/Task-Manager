...
function toggleStatus(id) {
  ...
  todo.status = todo.completed ? "completed" : "pending"; // Update the status based on completed status
  saveToLocalStorage();
  showAllTodos();
}
...
recognition.onresult = (event) => {
    ...
    searchInput.value = voiceResult; // Update the search input with voice result
    handleSearch(); // Perform search based on the voice result
};
